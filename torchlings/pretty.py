...
def print_welcome_message():
    click.echo(
        click.style(
            "Welcome to the torchlings! These exercises are designed to help get used to writing and running PyTorch code.",
            fg="bright_yellow",
        )
    )
    click.echo(
        click.style(
            "torchlings takes care of everything! Just write your code and save it :)",
            fg="bright_yellow",
        )
    )
    click.echo(
